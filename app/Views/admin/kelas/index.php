...
<div class="container-fluid content-frame mb-5 shadow">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="/admin/kelas/add" class="d-block d-sm-inline-block btn rounded-pill btn-wild-watermelon"><i class="fas fa-plus-square mr-1"></i>Tambah Kelas</a>
    </div>
            ...
            <?php foreach($class as $c): ?>
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href="/admin/kelas/edit/<?= $c['id']; ?>" class="btn btn-action btn-sm small mb-1"><span class="d-lg-none fa fa-pencil-alt"></span><span class="d-sm-none d-lg-inline">Edit</span></a>
